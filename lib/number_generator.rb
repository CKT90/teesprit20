    ...
    class NumberGenerator < Module
      ...
      def included(host) #host is base for the class included, in this case is Product
        generator_method   = method(:generate_permalink) #can call private method
        generator_instance = self #instance of NumberGenerator class


        host.class_eval do #this is for all instances of Product class
