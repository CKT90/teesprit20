    ...
    class SkuGenerator < Module
      ...
      def included(host)
        ...
        host.class_eval do
          validates(:SKU, presence: true, uniqueness: { allow_blank: true })

          before_validation do |instance|
            instance.SKU ||= generator_method.call(host)
          end
      ...
      def generate_permalink(host)
        ...
        loop do
          ...
          return candidate unless host.exists?(SKU: candidate)
